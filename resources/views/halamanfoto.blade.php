...
<nav class="navbar navbar-expand-lg fixed-top nav-home mb-5" data-bs-theme="dark" style="background-color: black">
  <div class="container">
      <a class="navbar-brand fw-normal text-white" href="#">
          <img src="foto/logo.png" alt="Logo" width="30" height="24"
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
              ...
              <li class="nav-item">
                  <a class="nav-link fw-medium active text-white" aria-current="page" href="gallery.html">GALLERY</a>
              </li>
              <li class="nav-item dropdown">
                  <a class="nav-link dropdown-toggle fw-medium active text-white" href="album.html" role="button" data-bs-toggle="dropdown"
                  aria-expanded="false">
                  ALBUM
                  </a>
              ...
              <li class="nav-item">
                  <a class="nav-link fw-medium active text-white" aria-current="page" href="aboutme.html">ABOUT ME</a>
              </li>
              <li class="nav-item">
      ...
      <table class="table container mt-5">
        <thead>
          ...
          <tr>
            ...
            <td>2024-10-04</td>
            <td>
              <img src="foto/img1.jpg" alt="" width="100">
            </td>
            <td>
              <a class="btn btn-danger" href="hapusfoto/" style="border-radius: 14px"><i class="fa fa-trash"></i></a>
              <a class="btn btn-success mx-3" href="edit-foto/" style="border-radius: 14px"><i class="fa fa-pen"></i></a>
              <a class="btn btn-primary" href="detailfoto.html" style="border-radius: 14px"><i class="fa fa-eye" aria-hidden="true"></i></a>
              <p></p>
            </td>
          </tr>
          </tbody>
