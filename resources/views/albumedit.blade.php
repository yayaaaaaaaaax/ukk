        ...
        <div class="accordion-body">
          <div class="container p-10">
            ...
            @if ($errors->any())
              ...
              @endforeach
            @endif
            <form class="container mt-5" action="{{$album->AlbumID}}" method="post">
              @csrf
              <div class="mb-3">
                <label for="exampleInputEmail1" class="form-label">Nama Album</label>
                <input type="text" class="form-control" name="NamaAlbum" value="{{ $album->NamaAlbum }}">
              </div>
              <div class="mb-3">
                <label for="exampleInputPassword1" class="form-label">Deskripsi</label>
                <input type="text" class="form-control" name="Deskripsi" value="{{ $album->Deskripsi }}">
              </div>
              <button type="submit" class="btn btn-primary mb-5">Edit Album</button>
            </form>
          </div>
        </div>
      </div>
